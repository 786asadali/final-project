...
--
-- Host: localhost
-- Generation Time: Aug 15, 2021 at 09:14 PM
...
(20, 2, '454545iyt', 5, 2, 'processed', '2022-12-05 10:16:38'),
(21, 2, '454545iyt', 6, 22, 'processed', '2022-12-05 10:16:42'),
(22, 2, '454545iyt', 5, 3, 'processed', '2022-12-05 10:42:42'),
(23, 2, '454545iyt', 5, 2, 'processed', '2022-12-05 10:57:16'),
(29, 1, NULL, 4, 2, 'unpocessed', '2022-12-06 00:06:57'),
(30, 1, NULL, 5, 222, 'unpocessed', '2022-12-06 00:07:00'),
(31, 1, NULL, 9, 20, 'unpocessed', '2022-12-06 00:07:10'),
(37, 3, 'RWE54REs', 1, 11, 'processed', '2022-12-06 18:48:02'),
(39, 3, 'RWe435FD', 3, 1, 'processed', '2022-12-06 18:48:07'),
(40, 3, NULL, 1, 22, 'unpocessed', '2022-12-06 18:49:13');
...
--
ALTER TABLE `Bills`
  MODIFY `BillID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `Orders`
  MODIFY `OrderID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
